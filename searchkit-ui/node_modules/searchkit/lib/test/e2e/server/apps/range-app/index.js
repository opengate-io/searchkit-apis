...
var App = (function (_super) {
    ...
    App.prototype.render = function () {
        return (React.createElement(SearchkitProvider, { searchkit: searchkit },
            React.createElement("div", { className: "sk-layout range-app" },
                React.createElement("div", { className: "sk-layout__top-bar sk-top-bar" },
                    React.createElement("div", { className: "sk-top-bar__content" },
                        React.createElement("div", { className: "my-logo" }, "Range components"),
                        React.createElement(SearchBox, { autofocus: true, searchOnChange: true, prefixQueryFields: ["actors^1", "type^2", "languages", "title^10"] }))),
                React.createElement("div", { className: "sk-layout__body" },
                    React.createElement("div", { className: "sk-layout__filters" },
                        React.createElement("div", { className: "sk-layout__filters-row" },
                            React.createElement(RangeFilter, { min: 0, max: 100, field: "metaScore", id: "metascore", title: "RangeHistogram", rangeComponent: RangeHistogram }),
                            React.createElement(RangeFilter, { min: 0, max: 100, field: "metaScore", id: "metascore", title: "RangeSliderHistogram", rangeComponent: RangeSliderHistogram }),
                            React.createElement(RangeFilter, { min: 0, max: 100, field: "metaScore", id: "metascore", title: "RangeHistogramInput", rangeComponent: RangeHistogramInput }),
                            React.createElement(RangeFilter, { min: 0, max: 100, field: "metaScore", id: "metascore", title: "RangeSliderHistogramInput", rangeComponent: RangeSliderHistogramInput }),
                            React.createElement(RangeFilter, { min: 0, max: 100, field: "metaScore", id: "metascore", title: "RangeSlider", rangeComponent: RangeSlider, rangeFormatter: function (count) { return count + " stars"; } }),
                            React.createElement(RangeFilter, { min: 0, max: 100, field: "metaScore", id: "metascore", title: "RangeInput", rangeComponent: RangeInput }),
                            React.createElement(RangeFilter, { min: 0, max: 100, field: "metaScore", id: "metascore", title: "RangeSliderInput", rangeComponent: RangeSliderInput }))),
                    React.createElement("div", { className: "sk-layout__results sk-results-list" },
                        ...
                        React.createElement(Hits, { hitsPerPage: 12, highlightFields: ["title", "plot"], sourceFilter: ["plot", "title", "poster", "imdbId", "imdbRating", "year"], mod: "sk-hits-grid", itemComponent: MovieHitsGridItem, scrollTo: "body" }),
