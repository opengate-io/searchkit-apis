...
exports.Paginator = {
    full: function (currentPage, totalPages, translate, pageScope) {
    ...
    relativePages: function (currentPage, totalPages, translate, pageScope) {
        if (pageScope === void 0) { pageScope = 3; }
        var builder = new PaginationHelper({
            currentPage: currentPage, totalPages: totalPages, translate: translate
        });
    ...
    previousNext: function (currentPage, totalPages, translate) {
        var builder = new PaginationHelper({
            currentPage: currentPage, totalPages: totalPages, translate: translate
        });
        builder.previous();
