...
describe("TagFilter tests", function () {
    ...
    it('renders correctly', function () {
        _this.createWrapper(React.createElement("div", null,
            React.createElement(_1.TagFilterConfig, { field: "test", id: "test id", title: "test title", operator: "OR", searchkit: _this.searchkit }),
            React.createElement(_1.TagFilter, { field: "test", value: "test option 1", searchkit: _this.searchkit }),
            React.createElement(_1.TagFilter, { field: "test", value: "test option 2", searchkit: _this.searchkit })));
        var output = TestHelpers_1.jsxToHTML(React.createElement("div", null,
            React.createElement("div", { className: "sk-tag-filter" }, "test option 1"),
            React.createElement("div", { className: "sk-tag-filter" }, "test option 2")));
        expect(TestHelpers_1.htmlClean(_this.wrapper.html())).toEqual(output);
    });
    it('renders with custom children', function () {
        ...
        var output = TestHelpers_1.jsxToHTML(React.createElement("div", null,
            React.createElement("div", { className: "sk-tag-filter" },
                React.createElement("div", { className: "custom-element" }, "test option"))));
        expect(TestHelpers_1.htmlClean(_this.wrapper.html())).toEqual(output);
    });
