...
describe("TagFilterList tests", function () {
    ...
    beforeEach(function () {
        ...
        _this.createWrapper(React.createElement("div", null,
            ...
            React.createElement(_1.TagFilterList, { field: "test", values: ["test option 1", "test option 2"], searchkit: _this.searchkit })));
    });
    it('renders correctly', function () {
        var output = TestHelpers_1.jsxToHTML(React.createElement("div", null,
            React.createElement("div", { className: "sk-tag-filter-list" },
