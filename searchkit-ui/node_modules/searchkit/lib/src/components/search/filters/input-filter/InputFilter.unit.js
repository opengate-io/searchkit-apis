...
describe("InputFilter tests", function () {
    ...
    it("should allow custom mod and className", function () {
        ...
        _this.setResults();
        expect(_this.wrapper.html()).toEqual(TestHelpers_1.jsxToHTML(React.createElement("div", { className: "sk-panel filter--test_id" },
            React.createElement("div", { className: "sk-panel__header" }, "Test title"),
            React.createElement("div", { className: "sk-panel__content" },
                React.createElement("div", { className: "my-input" },
                    React.createElement("form", null,
                        React.createElement("div", { className: "my-input__icon" }),
                        React.createElement("input", { type: "text", "data-qa": "input-filter", className: "my-input__text", placeholder: "search placeholder", value: "" }),
                        React.createElement("input", { type: "submit", value: "search", className: "my-input__action", "data-qa": "submit" }),
                        React.createElement("div", { "data-qa": "remove", className: "my-input__remove is-hidden" })))))));
    });
