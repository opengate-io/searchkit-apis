...
describe("MenuFilter", function () {
    ...
    it("should render correctly", function () {
        expect(_this.wrapper.html()).toEqual(TestHelpers_1.jsxToHTML(React.createElement("div", { className: "sk-panel filter--color" },
            React.createElement("div", { className: "sk-panel__header" }, "Color"),
            React.createElement("div", { className: "sk-panel__content" },
                React.createElement("div", { "data-qa": "options", className: "sk-item-list" },
                    React.createElement("div", { className: "sk-item-list-option sk-item-list__item is-active", "data-qa": "option", "data-key": "$all" },
                        ...
                        React.createElement("div", { "data-qa": "count", className: "sk-item-list-option__count" }, "33")),
                    React.createElement("div", { className: "sk-item-list-option sk-item-list__item", "data-qa": "option", "data-key": "Red" },
                        React.createElement("div", { "data-qa": "label", className: "sk-item-list-option__text" }, "Red Translated"),
                        React.createElement("div", { "data-qa": "count", className: "sk-item-list-option__count" }, "10")),
                    React.createElement("div", { className: "sk-item-list-option sk-item-list__item", "data-qa": "option", "data-key": "Blue" },
                        React.createElement("div", { "data-qa": "label", className: "sk-item-list-option__text" }, "Blue"),
                        React.createElement("div", { "data-qa": "count", className: "sk-item-list-option__count" }, "11")),
                    React.createElement("div", { className: "sk-item-list-option sk-item-list__item", "data-qa": "option", "data-key": "Green" },
                        React.createElement("div", { "data-qa": "label", className: "sk-item-list-option__text" }, "Green"),
