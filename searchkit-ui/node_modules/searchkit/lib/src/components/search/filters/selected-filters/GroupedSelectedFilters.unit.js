...
describe("GroupedSelectedFilters tests", function () {
    ...
    it('renders correctly', function () {
        _this.createWrapper();
        expect(_this.wrapper.html()).toEqual(TestHelpers_1.jsxToHTML(React.createElement("div", { className: "sk-filter-groups" },
            React.createElement("div", { className: "sk-filter-group filter-group-test" },
                React.createElement("div", { className: "sk-filter-group-items" },
                    React.createElement("div", { className: "sk-filter-group-items__title" }, "test name"),
                    React.createElement("div", { className: "sk-filter-group-items__list" },
                        React.createElement("div", { className: "sk-filter-group-items__value", "data-key": "test value" }, "test value"),
                        React.createElement("div", { className: "sk-filter-group-items__value", "data-key": "test value 3" }, "test value 3"))),
                React.createElement("div", { className: "sk-filter-group__remove-action" }, "X")),
            React.createElement("div", { className: "sk-filter-group filter-group-test2" },
                React.createElement("div", { className: "sk-filter-group-items" },
                    React.createElement("div", { className: "sk-filter-group-items__title" }, "test name 2 translated"),
                    React.createElement("div", { className: "sk-filter-group-items__list" },
                        React.createElement("div", { className: "sk-filter-group-items__value", "data-key": "test value 2" }, "test value 2 translated"))),
                React.createElement("div", { className: "sk-filter-group__remove-action" }, "X")))));
    });
