...
var TagFilterList = (function (_super) {
    ...
    TagFilterList.prototype.render = function () {
        ...
        return (React.createElement("div", { className: "sk-tag-filter-list" }, lodash_1.map(values, function (value) { return React.createElement(TagFilter_1.TagFilter, { key: value, field: field, value: value, searchkit: searchkit }); })));
    };
