...
describe("SortingSelector tests", function () {
    ...
    it("is disabled when no results", function () {
        ...
        expect(_this.wrapper.html()).toEqual(TestHelpers_1.jsxToHTML(React.createElement("div", { className: "sk-select is-disabled" },
            React.createElement("select", null,
                React.createElement("option", { value: "none" }, "Relevance translated"),
                React.createElement("option", { value: "released_desc" }, "Latest Releases"),
                React.createElement("option", { value: "earliest" }, "Earliest Releases")))));
    });
    it("renders with results", function () {
        _this.setResults();
        expect(_this.wrapper.children().length).toBe(1);
        expect(_this.wrapper.html()).toEqual(TestHelpers_1.jsxToHTML(React.createElement("div", { className: "sk-select" },
            React.createElement("select", null,
                React.createElement("option", { value: "none" }, "Relevance translated"),
                React.createElement("option", { value: "released_desc" }, "Latest Releases"),
                React.createElement("option", { value: "earliest" }, "Earliest Releases")))));
    ...
    it("renders with selected value", function () {
        ...
        _this.setWrapper();
        expect(_this.wrapper.html()).toEqual(TestHelpers_1.jsxToHTML(React.createElement("div", { className: "sk-select" },
            React.createElement("select", { onChange: _.identity },
                React.createElement("option", { value: "none" }, "Relevance translated"),
                React.createElement("option", { value: "released_desc" }, "Latest Releases"),
                React.createElement("option", { value: "earliest" }, "Earliest Releases")))));
    });
    ...
    it("custom mod, className, listComponent", function () {
        ...
        expect(_this.wrapper.html()).toEqual(TestHelpers_1.jsxToHTML(React.createElement("div", { "data-qa": "options", className: "my-select custom-class is-disabled" },
            React.createElement("div", { className: "my-select-option my-select__item is-active", "data-qa": "option", "data-key": "none" },
                React.createElement("div", { "data-qa": "label", className: "my-select-option__text" }, "Relevance")),
            React.createElement("div", { className: "my-select-option my-select__item", "data-qa": "option", "data-key": "released_desc" },
                React.createElement("div", { "data-qa": "label", className: "my-select-option__text" }, "Latest Releases")),
            React.createElement("div", { className: "my-select-option my-select__item", "data-qa": "option", "data-key": "earliest" },
                React.createElement("div", { "data-qa": "label", className: "my-select-option__text" }, "Earliest Releases")))));
    });
});
