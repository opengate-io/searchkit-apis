...
var SearchBox = (function (_super) {
    ...
    function SearchBox(props) {
        ...
        _this.throttledSearch = lodash_2.throttle(function () {
    ...
    SearchBox.prototype.defineAccessor = function () {
        ...
        return new core_1.QueryAccessor(id, {
            ...
            prefixQueryOptions: lodash_3.assign({}, prefixQueryOptions),
            queryFields: queryFields || ["_all"],
            queryOptions: lodash_3.assign({}, queryOptions),
...
SearchBox.propTypes = lodash_1.defaults({
    id: PropTypes.string,
