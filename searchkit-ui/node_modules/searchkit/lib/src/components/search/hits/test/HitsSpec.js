...
describe("Hits component", function () {
    describe('renders correctly', function () {
        beforeEach(function () {
            ...
            _this.customHighlightAccessor = _this.searchkit.accessors.accessors[2];
            _this.sourceFilterAccessor = _this.searchkit.accessors.accessors[3];
        ...
        it("does render", function () {
            ...
            expect(_this.wrapper.html()).toEqual(TestHelpers_1.jsxToHTML(React.createElement("div", { "data-qa": "hits", className: "sk-hits" },
        ...
        it("custom higher order component", function () {
            ...
            expect(wrapper.html()).toEqual(TestHelpers_1.jsxToHTML(React.createElement("div", { "data-qa": "hits", className: "sk-hits" },
                React.createElement("div", { className: "sk-hits-hit" }, "1"),
                React.createElement("div", { className: "sk-hits-hit" }, "2"))));
        });
    });
