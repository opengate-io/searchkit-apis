...
describe("InitialLoader", function () {
    ...
    it("should render correctly", function () {
        expect(_this.wrapper.html()).toEqual(TestHelpers_1.jsxToHTML(React.createElement("div", { className: "sk-initial-loader" },
            React.createElement("div", { "data-qa": "initial-loading", className: "sk-initial-loader__initial-loading" }))));
