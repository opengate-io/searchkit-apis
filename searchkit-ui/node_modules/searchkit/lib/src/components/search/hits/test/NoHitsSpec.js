...
describe("NoHits component", function () {
    ...
    describe("suggestions", function () {
        ...
        it("render error", function () {
            ...
            _this.wrapper.update();
            expect(_this.wrapper.html()).toEqual(TestHelpers_1.jsxToHTML(React.createElement("div", { "data-qa": "no-hits", className: "sk-no-hits" },
                React.createElement("div", { className: "sk-no-hits__info" }, "error"),
                React.createElement("div", { className: "sk-no-hits__steps" },
                    React.createElement("div", { className: "sk-no-hits__step-action" }, "Reset Search")))));
        });
    });
});
