...
describe("Layout components", function () {
    it("should render correctly", function () {
        ...
        expect(_this.wrapper.html()).toEqual(TestHelpers_1.jsxToHTML(React.createElement("div", null,
            React.createElement("div", { className: "sk-layout sk-layout__size-m" },
                React.createElement("div", { className: "sk-layout__top-bar sk-top-bar" },
                    React.createElement("div", { className: "sk-top-bar__content" }, "search bar")),
                React.createElement("div", { className: "sk-layout__body" },
                    React.createElement("div", { className: "sk-layout__filters" }, "filters"),
                    React.createElement("div", { className: "sk-layout__results sk-results-list" },
                        React.createElement("div", { className: "sk-results-list__action-bar sk-action-bar" },
                            React.createElement("div", { className: "sk-action-bar-row" }, "row 1"),
                            React.createElement("div", { className: "sk-action-bar-row" }, "row 2")),
                        React.createElement("p", null, "hits")))))));
    });
    it("layout - no size prop", function () {
        ...
        expect(_this.wrapper.html()).toEqual(TestHelpers_1.jsxToHTML(React.createElement("div", null,
            React.createElement("div", { className: "sk-layout" }, "content"))));
    });
});
