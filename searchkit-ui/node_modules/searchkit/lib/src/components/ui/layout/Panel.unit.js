...
describe("Panel", function () {
    ...
    it("should render correctly", function () {
        expect(_this.wrapper.html()).toEqual(TestHelpers_1.jsxToHTML(React.createElement("div", { className: "sk-panel" },
            React.createElement("div", { className: "sk-panel__header" }, "My Panel"),
    ...
    it("should be collapsable", function () {
        ...
        expect(_this.wrapper.html()).toEqual(TestHelpers_1.jsxToHTML(React.createElement("div", { className: "sk-panel" },
            React.createElement("div", { className: "sk-panel__header is-collapsable is-collapsed" }, "My Panel"),
            React.createElement("div", { className: "sk-panel__content is-collapsed" },
                React.createElement("p", null, "panel content...")))));
