...
describe("FilterGroup", function () {
    ...
    it("should render and behave correctly", function () {
        ...
        expect(_this.wrapper.html()).toEqual(TestHelpers_1.jsxToHTML(React.createElement("div", { className: "sk-filter-group filter-group-1" },
            React.createElement("div", { className: "sk-filter-group-items" },
                React.createElement("div", { className: "sk-filter-group-items__title" }, "GroupTitle"),
                React.createElement("div", { className: "sk-filter-group-items__list" },
                    React.createElement("div", { className: "sk-filter-group-items__value", "data-key": "A" }, "A translated"),
                    React.createElement("div", { className: "sk-filter-group-items__value", "data-key": "B" }, "B translated"),
                    React.createElement("div", { className: "sk-filter-group-items__value", "data-key": "C" }, "C translated"),
                    React.createElement("div", { className: "sk-filter-group-items__value", "data-key": "D" }, "D translated"))),
