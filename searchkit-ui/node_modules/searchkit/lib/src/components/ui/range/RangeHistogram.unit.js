...
describe("RangeHistogram", function () {
    it("should render and behave correctly", function () {
        ...
        expect(_this.wrapper.html()).toEqual(TestHelpers_1.jsxToHTML(React.createElement("div", { className: "sk-range-histogram" },
            React.createElement("div", { className: "sk-range-histogram__bar is-out-of-bounds", style: { height: ' 0%' } }),
            React.createElement("div", { className: "sk-range-histogram__bar is-out-of-bounds", style: { height: ' 0%' } }),
            React.createElement("div", { className: "sk-range-histogram__bar", style: { height: ' 0%' } }),
            React.createElement("div", { className: "sk-range-histogram__bar", style: { height: ' 60%' } }),
            React.createElement("div", { className: "sk-range-histogram__bar", style: { height: ' 70%' } }),
            React.createElement("div", { className: "sk-range-histogram__bar", style: { height: ' 80%' } }),
            React.createElement("div", { className: "sk-range-histogram__bar is-out-of-bounds", style: { height: ' 0%' } }),
            React.createElement("div", { className: "sk-range-histogram__bar is-out-of-bounds", style: { height: ' 100%' } }),
            React.createElement("div", { className: "sk-range-histogram__bar is-out-of-bounds", style: { height: ' 0%' } }),
            React.createElement("div", { className: "sk-range-histogram__bar is-out-of-bounds", style: { height: ' 0%' } }),
            React.createElement("div", { className: "sk-range-histogram__bar is-out-of-bounds", style: { height: ' 0%' } }))));
    });
