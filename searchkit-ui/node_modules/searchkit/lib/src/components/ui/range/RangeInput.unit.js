...
describe("RangeInput", function () {
    it("should render and behave correctly", function () {
        ...
        expect(_this.wrapper.html()).toEqual(TestHelpers_1.jsxToHTML(React.createElement("form", { className: "sk-range-input" },
            React.createElement("input", { type: "number", className: "sk-range-input__input", value: "2", placeholder: "min", onChange: function () { } }),
            React.createElement("div", { className: "sk-range-input__to-label" }, "-"),
            React.createElement("input", { type: "number", className: "sk-range-input__input", value: "5", placeholder: "max", onChange: function () { } }),
            React.createElement("button", { type: "submit", className: "sk-range-input__submit" }, "Go"))));
    });
