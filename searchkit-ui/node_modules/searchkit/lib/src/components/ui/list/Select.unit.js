    ...
    it("should render and behave correctly", function () {
        expect(_this.wrapper.html()).toEqual(TestHelpers_1.jsxToHTML(React.createElement("div", { className: "sk-select" },
            React.createElement("select", null,
                React.createElement("option", { value: "a" }, "A translated (#10)"),
                React.createElement("option", { value: "b", disabled: true }, "B translated (#11)"),
                React.createElement("option", { value: "c" }, "C translated (#12)"),
                React.createElement("option", { value: "d" }, "d translated (#15)")))));
