...
describe("ItemHistogramList Components", function () {
    it("should render and behave correctly", function () {
        ...
        expect(_this.wrapper.html()).toEqual(TestHelpers_1.jsxToHTML(React.createElement("div", { "data-qa": "options", className: "sk-item-list" },
            React.createElement("div", { className: "sk-item-list-option sk-item-list__item is-active is-histogram", "data-qa": "option", "data-key": "a" },
                React.createElement("div", { className: "sk-item-list-option__bar-container" },
                    React.createElement("div", { className: "sk-item-list-option__bar", style: { width: " 20.833333333333336%" } })),
                React.createElement("div", { "data-qa": "label", className: "sk-item-list-option__text" }, "A translated"),
                React.createElement("div", { "data-qa": "count", className: "sk-item-list-option__count" }, "#10")),
            React.createElement("div", { className: "sk-item-list-option sk-item-list__item is-disabled is-histogram", "data-qa": "option", "data-key": "b" },
                React.createElement("div", { className: "sk-item-list-option__bar-container" },
                    React.createElement("div", { className: "sk-item-list-option__bar", style: { width: " 22.916666666666664%" } })),
                React.createElement("div", { "data-qa": "label", className: "sk-item-list-option__text" }, "B translated"),
                React.createElement("div", { "data-qa": "count", className: "sk-item-list-option__count" }, "#11")),
            React.createElement("div", { className: "sk-item-list-option sk-item-list__item is-active is-histogram", "data-qa": "option", "data-key": "c" },
                React.createElement("div", { className: "sk-item-list-option__bar-container" },
                    React.createElement("div", { className: "sk-item-list-option__bar", style: { width: " 25%" } })),
                React.createElement("div", { "data-qa": "label", className: "sk-item-list-option__text" }, "C translated"),
                React.createElement("div", { "data-qa": "count", className: "sk-item-list-option__count" }, "#12")),
            React.createElement("div", { className: "sk-item-list-option sk-item-list__item is-histogram", "data-qa": "option", "data-key": "d" },
                React.createElement("div", { className: "sk-item-list-option__bar-container" },
                    React.createElement("div", { className: "sk-item-list-option__bar", style: { width: " 31.25%" } })),
                React.createElement("div", { "data-qa": "label", className: "sk-item-list-option__text" }, "d translated"),
                React.createElement("div", { "data-qa": "count", className: "sk-item-list-option__count" }, "#15")))));
