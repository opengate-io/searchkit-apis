...
function TermsBucket(key, field, options) {
    ...
    return AggsContainer_1.AggsContainer(key, {
        terms: lodash_1.assign({ field: field }, options)
    }, childAggs);
}
...
function SignificantTermsBucket(key, field, options) {
    ...
    return AggsContainer_1.AggsContainer(key, { significant_terms: lodash_1.assign({ field: field }, options) }, childAggs);
}
...
function GeohashBucket(key, field, options) {
    ...
    return AggsContainer_1.AggsContainer(key, { geohash_grid: lodash_1.assign({ field: field }, options) }, childAggs);
}
...
function HistogramBucket(key, field, options) {
    ...
    return AggsContainer_1.AggsContainer(key, { histogram: lodash_1.assign({ field: field }, options) }, childAggs);
}
