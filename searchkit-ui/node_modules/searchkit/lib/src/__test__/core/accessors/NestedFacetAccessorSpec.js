...
describe("NestedFacetAccessor", function () {
    ...
    it("getTermAggs()", function () {
        expect(_this.accessor.getTermAggs()).toEqual(_1.TermsBucket("children", "taxonomy.value", { size: _1.DefaultNumberBuckets, order: { taxonomy_order: "desc" } }, _1.MinMetric("taxonomy_order", "taxonomy.order")));
        _this.options.orderKey = "_count";
        _this.options.orderDirection = "asc";
        expect(_this.accessor.getTermAggs()).toEqual(_1.TermsBucket("children", "taxonomy.value", { size: _1.DefaultNumberBuckets, order: { "_count": "asc" } }));
        delete _this.options.orderKey;
        delete _this.options.orderDirection;
        expect(_this.accessor.getTermAggs()).toEqual(_1.TermsBucket("children", "taxonomy.value", { size: _1.DefaultNumberBuckets, order: undefined }));
    });
    ...
    it("buildOwnQuery()", function () {
        ...
        var termsBucket = _1.TermsBucket("children", "taxonomy.value", { size: _1.DefaultNumberBuckets, order: { taxonomy_order: "desc" } }, _1.MinMetric("taxonomy_order", "taxonomy.order"));
