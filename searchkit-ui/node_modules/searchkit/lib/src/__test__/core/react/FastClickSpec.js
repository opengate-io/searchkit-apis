...
_1.FastClick.component = _1.FastClickComponent;
describe("FastClick - fast", function () {
    beforeEach(function () {
        _this.handler = jasmine.createSpy("fastclick handler");
        _this.wrapper = enzyme_1.mount(React.createElement(_1.FastClick, { handler: _this.handler },
    ...
    describe("Touch events", function () {
        beforeEach(function () {
            _this.fastClick = _this.wrapper.find('FastClickComponent').node;
    ...
    it("Supports normal click", function () {
        _1.FastClick.component = _1.NormalClickComponent;
        _this.handler = jasmine.createSpy("fastclick handler");
        _this.wrapper = enzyme_1.mount(React.createElement(_1.FastClick, { handler: _this.handler },
            React.createElement("button", null, "click me")));
        _this.wrapper.simulate("click", event);
